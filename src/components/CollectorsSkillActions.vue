<template>
  <div>
    ...
    <div class="skillsAvailable" v-show="aboutToBuySkill" v-if="player">
      <h1 class="buySkillHeadings">{{ labels.chooseCardFromPlayerBoard }}:</h1>
      <div class="buySkillCardGrid">
        <div
          class="skillsFromBoard"
      ...
      <h1 class="buySkillHeadings">{{ labels.chooseCardFromPlayerHand }}:</h1>
      <div class="buySkillCardGrid">
        <div
          class="skillsFromHand"
